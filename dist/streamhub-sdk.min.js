...
define('text!streamhub-sdk/version.txt',[],function () { return 'dev\n';});
...
define('base64',['require','exports','module'],function (require, exports, module) {var base64={},chars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";function InvalidCharacterError(a){this.message=a}InvalidCharacterError.prototype=Error();InvalidCharacterError.prototype.name="InvalidCharacterError";
base64.btoa=window.btoa?function(a){return window.btoa(a)}:function(a){for(var c,d,b=0,f=chars,e="";a.charAt(b|0)||(f="=",b%1);e+=f.charAt(63&c>>8-b%1*8)){d=a.charCodeAt(b+=0.75);if(255<d)throw new InvalidCharacterError("'btoa' failed: The string to be encoded contains characters outside of the Latin1 range.");c=c<<8|d}return e};
base64.atob=window.atob?function(a){return window.atob(a)}:function(a){a=a.replace(/=+$/,"");if(1==a.length%4)throw new InvalidCharacterError("'atob' failed: The string to be decoded is not correctly encoded.");for(var c=0,d,b,f=0,e="";b=a.charAt(f++);~b&&(d=c%4?64*d+b:b,c++%4)?e+=String.fromCharCode(255&d>>(-2*c&6)):0)b=chars.indexOf(b);return e};module.exports=base64;
...
define('streamhub-sdk/collection/clients/permalink-client',['require','exports','module','streamhub-sdk/collection/clients/http-client','inherits'],function (require, exports, module) {'use strict'
...
define('streamhub-sdk/content/clients/content-client',['require','exports','module','streamhub-sdk/jquery','inherits','streamhub-sdk/collection/clients/http-client'],function (require, exports, module) {var $ = require('streamhub-sdk/jquery');
var inherits = require('inherits');
var LivefyreHttpClient = require('streamhub-sdk/collection/clients/http-client');
...
define('streamhub-sdk/content/fetch-content',['require','exports','module','streamhub-sdk/content/clients/content-client','streamhub-sdk/content/state-to-content'],function (require, exports, module) {var LivefyreContentClient = require('streamhub-sdk/content/clients/content-client');
...
define('streamhub-sdk', ['streamhub-sdk/main'], function (main) { return main; });
...
define('view/view',['require','exports','module','jquery','event-emitter','inherits','view/event-map'],function (require, exports, module) {var $ = require('jquery');
...
define('streamhub-ui/command',['require','exports','module','event-emitter','inherits'],function (require, exports, module) {
...
define('streamhub-ui/auth-required-command',['require','exports','module','auth','streamhub-ui/command','inherits'],function (require, exports, module) {var auth = require('auth');
...
define('streamhub-sdk/ui/auth-required-command',['require','exports','module','streamhub-ui/auth-required-command'],function (require, exports, module) {module.exports = require('streamhub-ui/auth-required-command');

});

define('streamhub-sdk/ui/command',['require','exports','module','streamhub-ui/command'],function (require, exports, module) {module.exports = require('streamhub-ui/command');

});

define("hgn!streamhub-ui/templates/button", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");if(_.s(_.f("buttonUrl",c,p,1),c,p,0,14,87,"{{ }}")){_.rs(c,p,function(c,p,_){_.b("    <a href=\"");_.b(_.t(_.f("buttonUrl",c,p,0)));_.b("\" target=\"_blank\">");_.b(_.t(_.f("buttonLabel",c,p,0)));_.b("</a>");_.b("\n");});c.pop();}if(!_.s(_.f("buttonUrl",c,p,1),c,p,1,0,0,"")){_.b("    ");_.b(_.t(_.f("buttonLabel",c,p,0)));_.b("\n");};return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

define('streamhub-ui/button',['require','exports','module','hgn!streamhub-ui/templates/button','streamhub-ui/command','inherits','view'],function (require, exports, module) {
...
define('streamhub-sdk/ui/button',['require','exports','module','streamhub-ui/button'],function (require, exports, module) {module.exports = require('streamhub-ui/button');
});

define('streamhub-sdk/ui/hub-button',['require','exports','module','streamhub-sdk/ui/button','streamhub-sdk/ui/command','inherits'],function (require, exports, module) {
...
define('streamhub-sdk/ui/hub-toggle-button',['require','exports','module','streamhub-sdk/ui/hub-button','inherits'],function (require, exports, module) {
...
define('streamhub-sdk/ui/hub-like-button',['require','exports','module','auth','streamhub-sdk/ui/hub-toggle-button','streamhub-sdk/ui/auth-required-command','inherits'],function (require, exports, module) {
...
define('streamhub-sdk/collection/liker',[
    'streamhub-sdk/auth',
    'streamhub-sdk/collection/clients/write-client',
...
define('streamhub-sdk/content/views/livefyre-content-view',[
    'streamhub-sdk/jquery',
    'auth',
...
define('streamhub-sdk/content/views/twitter-content-view',[
...
define('streamhub-sdk/content/views/facebook-content-view',[
    'streamhub-sdk/content/views/livefyre-content-view',
    'inherits',
    'streamhub-sdk/jquery'],
...
define('streamhub-sdk/content/views/instagram-content-view',[
    'streamhub-sdk/content/views/livefyre-content-view',
...
define('streamhub-sdk/content/views/gallery-on-focus-view',[
	'inherits',
	'streamhub-sdk/view',
...
define('streamhub-ui/util/functions',['require','exports','module'],function (require, exports, module) {'use strict'
...
define('streamhub-ui/util/user-agent',['require','exports','module','streamhub-ui/util/functions'],function (require, exports, module) {/**
...
define("hgn!streamhub-ui/templates/lfwrapper", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"lf\"></div>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

define("hgn!streamhub-ui/templates/container", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"lf-thread-content\"></div>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

define('streamhub-ui/container',['require','exports','module','jquery','inherits','streamhub-ui/util/user-agent','view','hgn!streamhub-ui/templates/lfwrapper','hgn!streamhub-ui/templates/container'],function (require, exports, module) {/**
...
define('streamhub-ui/util/dom',['require','exports','module','streamhub-ui/util/user-agent'],function (require, exports, module) {/**
...
define("hgn!streamhub-ui/templates/popover", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"lf-thread-content lf-popover-content\"></div>");_.b("\n" + i);_.b("<div class=\"lf-popover-arrow\"></div>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

define('streamhub-ui/popover',['require','exports','module','jquery','streamhub-ui/container','streamhub-ui/util/dom','inherits','hgn!streamhub-ui/templates/popover'],function (require, exports, module) {/**
...
Popover.prototype._getBottomPosition = function (elem) {
    ...
    // debugger
    var width = (availableWidth < this.opts.maxWidth || Number.POSITIVE_INFINITY) ? this.opts.maxWidth : this.opts.maxWidth;
...
define("hgn!streamhub-ui/templates/menu/link", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<li data-value=\"");_.b(_.v(_.f("key",c,p,0)));_.b("\" class=\"lf-");_.b(_.v(_.f("key",c,p,0)));_.b(" ");_.b(_.v(_.f("cls",c,p,0)));_.b("\">");_.b(_.v(_.f("str",c,p,0)));_.b("</li>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

define("hgn!streamhub-ui/templates/mobile/navbar", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<button type=\"button\" class=\"lf-menu-back-btn lf-btn lf-btn-sm lf-btn-default\">");_.b(_.t(_.d("strings.backBtn",c,p,0)));_.b("</button>");_.b("\n" + i);_.b("<h3>");_.b(_.t(_.d("strings.title",c,p,0)));_.b("</h3>");_.b("\n" + i);if(_.s(_.f("actionButton",c,p,1),c,p,0,160,264,"{{ }}")){_.rs(c,p,function(c,p,_){_.b("    <button type=\"button\" class=\"lf-menu-action-btn lf-btn lf-btn-sm\">");_.b(_.v(_.d("strings.actionBtn",c,p,0)));_.b("</button>");_.b("\n");});c.pop();}return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

define("hgn!streamhub-ui/templates/navigablesub", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

define("hgn!streamhub-ui/templates/navigable", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");if(_.s(_.f("topNavEnabled",c,p,1),c,p,0,18,88,"{{ }}")){_.rs(c,p,function(c,p,_){_.b("    <header class=\"lf-menu-head\">");_.b("\n" + i);_.b(_.rp("navbar",c,p,"        "));_.b("    </header>");_.b("\n");});c.pop();}_.b("<div class=\"lf-menu-body\">");_.b("\n" + i);_.b(_.rp("body",c,p,"    "));_.b("</div>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

define('streamhub-ui/navigable',['require','exports','module','inherits','streamhub-ui/util/user-agent','view','hgn!streamhub-ui/templates/mobile/navbar','hgn!streamhub-ui/templates/navigablesub','hgn!streamhub-ui/templates/navigable'],function (require, exports, module) {/**
...
define('streamhub-ui/menu/base',['require','exports','module','jquery','inherits','hgn!streamhub-ui/templates/menu/link','streamhub-ui/navigable','streamhub-ui/util/user-agent'],function (require, exports, module) {/**
...
define("hgn!streamhub-ui/templates/loader", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"lf-loader-container\"></div>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

define("hgn!streamhub-ui/templates/menu/share", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<footer class=\"lf-menu-foot\">");_.b("\n" + i);_.b("    <textarea readonly>");_.b(_.v(_.f("permalink",c,p,0)));_.b("</textarea>");_.b("\n" + i);_.b("</footer>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

define('streamhub-ui/menu/share',['require','exports','module','jquery','streamhub-ui/menu/base','inherits','livefyre-bootstrap/loader','hgn!streamhub-ui/templates/loader','hgn!streamhub-ui/templates/menu/share'],function (require, exports, module) {/**
...
define('streamhub-share/util/share-format',['require','exports','module'],function (require, exports, module) {/**
...
define('streamhub-share/share-menu',['require','exports','module','jquery','streamhub-ui/menu/base','inherits','livefyre-bootstrap/loader','streamhub-ui/menu/share','streamhub-share/util/share-format'],function (require, exports, module) {'use strict'
...
define('streamhub-share/share-command',['require','exports','module','jquery','streamhub-ui/command','inherits','streamhub-ui/popover','streamhub-share/share-menu'],function (require, exports, module) {'use strict'
...
ShareCommand.prototype._defaultFn = function () {
    ...
    function showShare() {
        ...
        share.render();
        //TODO (joao) Opts to position -80px leftward
...
define('streamhub-share/share-button',['require','exports','module','streamhub-ui/button','inherits','streamhub-share/share-command'],function (require, exports, module) {
...
define('streamhub-share', ['streamhub-share/share-button'], function (main) { return main; });

define('streamhub-sdk/content/content-view-factory',[
    'auth',
    'streamhub-sdk/content',
    'streamhub-sdk/content/types/livefyre-content',
    'streamhub-sdk/content/types/livefyre-twitter-content',
...
define('streamhub-sdk/modal/views/attachment-gallery-modal',[
    'streamhub-sdk/modal',
    'streamhub-sdk/content/views/gallery-attachment-list-view',
    'inherits'
...
define('streamhub-sdk/content/views/content-list-view',[
    'streamhub-sdk/jquery',
...
define('streamhub-sdk/views/streams/injector',[
    'inherits',
    'stream/writable',
    'stream/readable',
...
//# sourceMappingURL=streamhub-sdk.min.js.map