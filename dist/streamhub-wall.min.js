(function (root, factory) {
    if ((typeof Livefyre === 'object') && (typeof Livefyre.define === 'function') && Livefyre.define.amd) {
        if (Livefyre.require.almond) {
            Livefyre.define('streamhub-wall', [], factory);
        } else {
...
define('view/view',['require','exports','module','jquery','event-emitter','view/event-map','inherits'],function (require, exports, module) {var $ = require('jquery');
...
define('auth/util/bind',['require','exports','module'],function (require, exports, module) {module.exports = function(fn, selfObj, var_args) {
	if (!fn) {
		throw new Error();
	}
...
define('auth/auth',['require','exports','module','inherits','event-emitter','debug','./util/bind'],function (require, exports, module) {/**
...
define('auth/main',['require','exports','module','./auth'],function (require, exports, module) {var Auth = require('./auth');
...
define('text!streamhub-wall/style.css',[],function () { return '.streamhub-media-wall-view {\n    position:relative;\n}\n.streamhub-media-wall-view .hub-wall-column {\n    display: inline-block;\n    vertical-align: top;\n    -moz-box-sizing: border-box;\n    -webkit-box-sizing: border-box;\n    box-sizing: border-box;\n    padding: 5px; }\n';});

define('streamhub-wall/main',[
    'streamhub-sdk/jquery',
...
define('streamhub-wall', ['streamhub-wall/main'], function (main) { return main; });
    //The modules for your project will be inlined above
    //this snippet. Ask almond to synchronously require the
    //module value for 'main' here and return it as the
    //value to use for the public API for the built file.
    return require('streamhub-wall');
}));

//# sourceMappingURL=streamhub-wall.min.js.map